...
let player1 = List.rev (create_pieces 4)

let player1 = put_pieces_inplay player1 1

let player2 = List.rev (create_pieces 4)

let player2 = put_pieces_inplay player2 1

let player2 = put_pieces_inplay player2 2

let player3 = List.rev (create_pieces 4)

let player3 = put_pieces_inplay player3 1

let player3 = put_pieces_inplay player3 2

let player3 = put_pieces_inplay player3 3

let player4 = List.rev (create_pieces 4)

let player4 = put_pieces_inplay player4 1

let player4 = put_pieces_inplay player4 2

let player4 = put_pieces_inplay player4 3

let player4 = put_pieces_inplay player4 4
...
let player_model_tests =
  [
    ...
    >:: fun _ -> assert_equal player1 (put_pieces_inplay player0 1) );
    ( "[put_pieces_inplay] test: player putting piece 1 and 2 in play"
    >:: fun _ -> assert_equal player2 (put_pieces_inplay player1 2) );
    ( "[put_pieces_inplay] test: player putting pieces 1,2,3 in play"
    >:: fun _ -> assert_equal player3 (put_pieces_inplay player2 3) );
    ( "[put_pieces_inplay] test: player putting pieces 1,2,3,4 in play"
    >:: fun _ -> assert_equal player4 (put_pieces_inplay player3 4) );
